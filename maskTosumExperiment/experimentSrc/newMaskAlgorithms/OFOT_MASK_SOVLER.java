...
public class OFOT_MASK_SOVLER {
	...
	public OFOT_MASK_SOVLER(TestCase testCase, int[] param,
		...
		testTuple = new TestTupleSuspiciousWithSolver(caseRunner, param, testCase, level);
		// runner = caseRunner;
	}
