...
public class FIC_MASK {
	...
	public FIC_MASK(TestCase testCase, int[] param, CaseRunner caseRunner,
			int level) {
		...
		testTuple = new TestTuple(caseRunner, param, testCase);
	}
	...
	public static void main(String[] args) {
		...
		FIC_MASK fic = new FIC_MASK(wrongCase, param, caseRunner, level);
		fic.FicNOP();
