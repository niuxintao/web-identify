...
public class RI_Web {
	...
	/**
	 * call this method to set the current test case state, i.e., pass or fail
	 * @param state
	 */
	...
	/**
	 * call this to get the next test case to execute
	 * @return
	 */
	...
	public RI_Web(CorpTupleWithTestCase generate, CaseRunner caseRunner) {
	...
	public static void main(String[] args) {
		...
		System.out.println(ri.getAddtionalTestSuite().getTestCaseNum());
		for (Tuple tuple : tupleg)
			System.out.println(tuple.toString());
		for (int i = 0; i < ri.getAddtionalTestSuite().getTestCaseNum(); i++)
			System.out
					.println(ri.getAddtionalTestSuite().getAt(i).getStringOfTest());
	}
