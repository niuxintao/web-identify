...
public class SimpleExperiment {
	...
	public void test(int algorithm, String subject, ExperimentData data) {
		...
		OutPut statistic = new OutPut("multipleDefects/avg/" + s + "statistic for " + subject
				+ ".txt");
		OutPut statisticDev = new OutPut("multipleDefects/dev/" + s + "statistic for "
				+ subject + ".txt");

		OutPut out2 = new OutPut("multipleDefects/specific/" + s + "2-way for " + subject
				+ ".txt");
		...
		OutPut out3 = new OutPut("multipleDefects/specific/" + s + "3-way for " + subject
				+ ".txt");
		...
		OutPut out4 = new OutPut("multipleDefects/specific/" + s + "4-way for " + subject
				+ ".txt");
	...
	public void testSubject() {
		...
		String subject = "hsqldb 2.0rc";
		MultipleDefectsData data = new MultipleDefectsData(0);
		/******************************/
		testAlgorithm(subject, data, REP.ALG);
		
		
		subject = "hsqldb 2.25";
		data = new MultipleDefectsData(1);
		/******************************/
		testAlgorithm(subject, data, REP.ALG);
		
		subject = "hsqldb 2.29";
		data = new MultipleDefectsData(2);
		/******************************/
		testAlgorithm(subject, data, REP.ALG);
		
		
		subject = "jflex 1.4.1";
		data = new MultipleDefectsData(3);
		/******************************/
		testAlgorithm(subject, data, REP.ALG);
		
		subject = "jflex 1.4.2";
		data = new MultipleDefectsData(4);
		/******************************/
		testAlgorithm(subject, data, REP.ALG);
