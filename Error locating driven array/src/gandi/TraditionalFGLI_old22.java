...
public class TraditionalFGLI_old22 implements CT_process {
	...
	public TraditionalFGLI_old22(DataCenter dataCenter, CaseRunner caseRunner) {
	...
	public static void main(String[] args) {
		...
		TraditionalFGLI_old22 fglt = new TraditionalFGLI_old22(dataCenter, caseRunner);
		fglt.run();
